    ...
    public static enum Orientation {
        ...
        public static Orientation curved(BlockFace blockFace, BlockFace blockFace2) {
            for (Orientation orientation : new Orientation[]{CURVED_SOUTH_EAST, CURVED_SOUTH_WEST, CURVED_NORTH_WEST, CURVED_NORTH_EAST}) {
                if (!orientation.a.contains(blockFace) || !orientation.a.contains(blockFace2)) continue;
                return orientation;
            }
        ...
        static {
            ...
            for (int k = 0; k < n; ++k) {
                Orientation orientation = orientationArray[k];
                Orientation.f[orientation.b] =orientation;
            }
        }
