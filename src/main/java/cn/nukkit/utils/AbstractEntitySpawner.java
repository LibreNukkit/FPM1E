        ...
        if (SpawnerTask.a(level, this.getEntityNetworkId(), player)) {
            ...
            if (this.getEntityNetworkId() == 58) {
                if (!level.isInSpawnRadius(position)) {
                    position.x += Utils.rand(-2, 2);
                    position.y += Utils.rand(20, 34);
                    position.z += Utils.rand(-2, 2);
                    this.spawn(player, position, level);
                }
            } else {
                position.x += SpawnerTask.a(Utils.rand(48, 52), Utils.rand(24, 28), Utils.rand(4, 8));
                position.z += SpawnerTask.a(Utils.rand(48, 52), Utils.rand(24, 28), Utils.rand(4, 8));
