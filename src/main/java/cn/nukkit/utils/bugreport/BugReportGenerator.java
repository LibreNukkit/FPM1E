...
extends Thread {
    ...
    private void a() {
        ...
        var object3 = Server.getInstance().getPluginManager().getPlugins().values();
        try {
            var object2 = object3.iterator();
            while (object2.hasNext()) {
                var object = (Plugin)object2.next();
        ...
        var object2 = System.getenv("PROCESSOR_IDENTIFIER");
        var object = ManagementFactory.getOperatingSystemMXBean();
