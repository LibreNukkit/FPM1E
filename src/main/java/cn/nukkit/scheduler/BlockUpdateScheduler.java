...
public class BlockUpdateScheduler {
    ...
    private long b;
    private final Long2ObjectMap<LinkedHashSet<BlockUpdateEntry>> a = new Long2ObjectOpenHashMap<>();
    ...
    public synchronized void tick(long l) {
        if (l - this.b < 32767L) {
            ...
            long l2;
            ArrayList<Long> arrayList = new ArrayList<>(this.a.keySet());
    ...
    private void a(long l) {
        try {
            this.b = l;
            Set<BlockUpdateEntry> set = this.d = this.a.remove(l);
            if (set != null) {
    ...
    public Set<BlockUpdateEntry> getPendingBlockUpdates(AxisAlignedBB axisAlignedBB) {
        ...
        for (var entry : this.a.entrySet()) {
            var  linkedHashSet2 = entry.getValue();
    ...
    public void add(BlockUpdateEntry blockUpdateEntry) {
        ...
        LinkedHashSet<BlockUpdateEntry> linkedHashSet2 = this.a.get(l);
        if (linkedHashSet2 == null && (linkedHashSet = this.a.putIfAbsent(l, linkedHashSet2 = new LinkedHashSet<>())) != null) {
