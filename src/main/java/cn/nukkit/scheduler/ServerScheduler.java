...
public class ServerScheduler {
    ...
    private final Queue<TaskHandler> d = new ConcurrentLinkedQueue<>();
    ...
    public ServerScheduler() {
        this.e = new PriorityQueue<>(11, (taskHandler, taskHandler2) -> {
    ...
    private TaskHandler a(Task task, int n, int n2, boolean bl) {
        return this.a(task instanceof PluginTask ? ((PluginTask<?>)task).getOwner() : null, task, n, n2, bl);
    }
