...
extends ContainerInventory {
    ...
    public void onOpen(Player player) {
        ...
        if (entityChestBoat != null) {
            containerOpenPacket.x = (int) entityChestBoat.getX();
            containerOpenPacket.y = (int) entityChestBoat.getY();
            containerOpenPacket.z = (int) entityChestBoat.getZ();
        } else {
        ...
        if (entityChestBoat != null) {
            containerOpenPacket.entityId = entityChestBoat.getId();
        }
