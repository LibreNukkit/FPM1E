...
extends BaseInventory {
    ...
    public void onOpen(Player player) {
        ...
        if (inventoryHolder instanceof Vector3) {
            containerOpenPacket.x = (int)((Vector3) inventoryHolder).getX();
            containerOpenPacket.y = (int)((Vector3) inventoryHolder).getY();
            containerOpenPacket.z = (int)((Vector3) inventoryHolder).getZ();
        } else {
        ...
        if (inventoryHolder instanceof Entity) {
            containerOpenPacket.entityId = ((Entity) inventoryHolder).getId();
        }
