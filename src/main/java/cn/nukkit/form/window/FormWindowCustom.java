...
extends FormWindow {
    ...
    public void setResponse(String string) {
        ...
        List<String> list = GSON.fromJson(string, new ListTypeToken(null).getType());
        int n = 0;
        HashMap<Integer, FormResponseData> hashMap = new HashMap<>();
        HashMap<Integer, String> hashMap2 = new HashMap<>();
        HashMap<Integer, Float> hashMap3 = new HashMap<>();
        HashMap<Integer, FormResponseData> hashMap4 = new HashMap<>();
        ...
        for (String string2 : list) {
            ...
            if (element instanceof ElementLabel) {
                ...
                object = Float.parseFloat(string2);
    ...
    public void setElementsFromResponse() {
        if (this.response != null) {
            this.response.getResponses().forEach((n, object) -> {
                Element element = this.content.get(n);
                if (element != null) {
