...
extends DataPacket {
    ...
    public String toString() {
        return "NPCRequestPacket(entityRuntimeId=" + this.entityRuntimeId + ", requestType=" + this.requestType + ", commandString=" + this.commandString + ", actionType=" + this.actionType + ", sceneName=" + this.sceneName + ")";
    }
