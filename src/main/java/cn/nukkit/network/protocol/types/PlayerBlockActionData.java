...
public class PlayerBlockActionData {
    ...
    public boolean equals(Object object) {
        ...
        if (playerActionType == null ? playerActionType2 != null : !((Object) playerActionType).equals(playerActionType2)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int n2 = 1;
        PlayerActionType playerActionType = this.getAction();
        n2 = n2 * 59 + (playerActionType == null ? 43 : ((Object) playerActionType).hashCode());
        BlockVector3 blockVector3 = this.getPosition();
    ...
    public String toString() {
        return "PlayerBlockActionData(action=" + this.getAction() + ", position=" + this.getPosition() + ", facing=" + this.getFacing() + ")";
    }
