...
extends DataPacket {
    ...
    private long k;
    private Vector3f l;
    private final Map<PlayerActionType, PlayerBlockActionData> g = new EnumMap<>(PlayerActionType.class);
    ...
    public void decode() {
        ...
        if (this.e.contains(AuthInputAction.PERFORM_BLOCK_ACTIONS)) {
            n = this.getVarInt();
            if (n > 512) {
    ...
    public String toString() {
        return "PlayerAuthInputPacket(yaw=" + this.getYaw() + ", pitch=" + this.getPitch() + ", headYaw=" + this.getHeadYaw() + ", position=" + this.getPosition() + ", motion=" + this.getMotion() + ", inputData=" + this.getInputData() + ", inputMode=" + this.getInputMode() + ", playMode=" + this.getPlayMode() + ", interactionModel=" + this.getInteractionModel() + ", vrGazeDirection=" + this.getVrGazeDirection() + ", tick=" + this.getTick() + ", delta=" + this.getDelta() + ", blockActionData=" + this.getBlockActionData() + ")";
    }
