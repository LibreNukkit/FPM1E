...
extends DataPacket {
    ...
    public void decode() {
        ...
        for (int k = 0; k < n; ++k) {
            ...
            ObjectArrayList<EnchantData> objectArrayList = new ObjectArrayList<>();
            for (int i2 = 0; i2 < n4; ++i2) {
                var object2 = new EnchantData(this.getByte(), this.getByte());
            ...
            ObjectArrayList<EnchantData> objectArrayList2 = new ObjectArrayList<>();
            for (int i3 = 0; i3 < n4; ++i3) {
                var object = new EnchantData(this.getByte(), this.getByte());
    ...
    public static final class EnchantOptionData {
        private final int b;
        private final int g;
