...
AdvancedSourceInterface {
    ...
    private Network c;
    private byte[] f;
    private final Map<InetSocketAddress, RakNetPlayerSession> a = new HashMap<>();
    ...
    public boolean process() {
        ...
        while ((rakNetPlayerSession = this.d.poll()) != null) {
            var object3 = rakNetPlayerSession.getRakNetSession().getAddress();
            try {
                var object2 = new PlayerCreationEvent(this, Player.class, Player.class, null, (InetSocketAddress)object3);
                ...
                var object = ((PlayerCreationEvent)object2).getPlayerClass().getConstructor(SourceInterface.class, Long.class, InetSocketAddress.class);
        ...
        var object3 = this.a.values().iterator();
        while (object3.hasNext()) {
            var object2 = (RakNetPlayerSession)object3.next();
            var object = ((RakNetPlayerSession)object2).getPlayer();
    ...
    public void onUnhandledDatagram(ChannelHandlerContext channelHandlerContext, DatagramPacket datagramPacket) {
        this.e.handlePacket(datagramPacket.sender(), datagramPacket.content());
    }
