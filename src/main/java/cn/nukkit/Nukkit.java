...
public class Nukkit {
    ...
    public static void main(String[] stringArray) {
        ...
        try {
            if (TITLE) {
                System.out.print("\u001b]0;Nukkit FPetteriM1 Edition\u0007");
            }
        ...
        for (Thread thread : Thread.getAllStackTraces().keySet()) {
            ...
            a.debug("Stopping {} thread", thread.getClass().getSimpleName());
    ...
    private static Properties a() {
        ...
        try {
            ...
            a.debug("Unable to load git.properties", iOException);
            return null;
        }
        return properties;
    }
    ...
    static {
        MAIN_BRANCH = "master";
        b = "https://api.github.com/repos/Blackjack200/NukkitFPM1Edition/releases";
        NUKKIT_PM1E = "Nukkit FFPetteriM1 Edition";
