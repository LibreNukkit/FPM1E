...
implements Faceable {
    ...
    private boolean a(boolean bl, BlocksCalculator blocksCalculator) {
        ...
        if (blocksCalculator.canMove()) {
            ...
            ArrayList<Block> arrayList = new ArrayList<>(list);
            ...
            for (n = list.size() - 1; n >= 0; --n) {
                ...
                this.level.setBlock(position, arrayList.get(n), true, false);
            }
            if (bl) {
    ...
    public static class BlocksCalculator {
        ...
        public boolean canMove() {
            return this.canMove == null ? (this.canMove = this.a()) : this.canMove;
        }
        ...
        private void a(int n, int n2) {
            ArrayList<Block> arrayList = new ArrayList<>(this.b.subList(0, n2));
            ArrayList<Block> arrayList2 = new ArrayList<>(this.b.subList(this.b.size() - n, this.b.size()));
            ArrayList<Block> arrayList3 = new ArrayList<>(this.b.subList(n2, this.b.size() - n));
            this.b.clear();
