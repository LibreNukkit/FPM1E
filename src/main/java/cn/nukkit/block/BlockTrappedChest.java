...
extends BlockChest {
    ...
    public boolean place(Item item, Block block, Block block2, BlockFace blockFace, double d2, double d3, double d4, Player player) {
        ...
        for (var object22 : BlockFace.Plane.HORIZONTAL) {
            BlockEntity object3;
            Object object4;
            if ((this.getDamage() == 4 || this.getDamage() == 5) && (object22 == BlockFace.WEST || object22 == BlockFace.EAST) || (this.getDamage() == 3 || this.getDamage() == 2) && (object22 == BlockFace.NORTH || object22 == BlockFace.SOUTH) || !((object4 = this.getSide((BlockFace) object22)) instanceof BlockTrappedChest) || ((Block)object4).getDamage() != this.getDamage() || !((object3 = this.getLevel().getBlockEntity((Vector3)object4)) instanceof BlockEntityChest) || ((BlockEntityChest)object3).isPaired()) continue;
        ...
        if (item.hasCustomBlockData()) {
            var object22 = item.getCustomBlockData().getTags();
            for (var entry : object22.entrySet()) {
                compoundTag.put((String)entry.getKey(), (Tag)entry.getValue());
            }
        }
        var object22 = BlockEntity.createBlockEntity("Chest", this.getChunk(), compoundTag, new Object[0]);
