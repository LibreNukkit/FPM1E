...
extends BlockCrops {
        ...
        if (n == 1) {
            ...
            if (Utils.rand()) {
                ...
                for (var object22 : BlockFace.Plane.HORIZONTAL) {
                    var object = this.getSide((BlockFace) object22);
                    if (((Block)object).getId() != 103) continue;
                    return 2;
                }
                ...
                if (block.getId() == 0 && (((Block)(object22 = block.down())).getId() == 60 || ((Block)object22).getId() == 2 || ((Block)object22).getId() == 3)) {
                    var object = new BlockGrowEvent(block, Block.get(103));
    ...
    public Item[] getDrops(Item item) {
        ...
        return new Item[]{Item.get(362, 0, Utils.rand(0, 48) >> 4)};
    }
