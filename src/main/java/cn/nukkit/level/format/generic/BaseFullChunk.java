...
ChunkManager {
    ...
    public BaseFullChunk clone() {
        ...
        block7: {
            ...
            if (this.biomes != null) {
                baseFullChunk.biomes = this.biomes.clone();
            }
            if (this.blocks != null) {
                baseFullChunk.blocks = this.blocks.clone();
            }
            if (this.data != null) {
                baseFullChunk.data = this.data.clone();
            }
            if (this.skyLight != null) {
                baseFullChunk.skyLight = this.skyLight.clone();
            }
            if (this.blockLight != null) {
                baseFullChunk.blockLight = this.blockLight.clone();
            }
            if (this.heightMap == null) break block7;
            baseFullChunk.heightMap = this.getHeightMapArray().clone();
        }
    ...
    protected BaseFullChunk fullClone() {
        ...
        if (this.heightMap != null) {
            baseFullChunk.heightMap = this.heightMap.clone();
        }
        if (this.entities != null) {
            baseFullChunk.entities = new Long2ObjectOpenHashMap<>(this.entities);
        }
        if (this.tiles != null) {
            baseFullChunk.tiles = new Long2ObjectOpenHashMap<>(this.tiles);
        }
        ...
        if (this.getProvider() != null && !this.isInit) {
            ...
            if (this.NBTentities != null) {
                ...
                for (CompoundTag compoundTag : this.NBTentities) {
                    ...
                    if (((NumberTag<?>)((ListTag<?>)object).get(0)).getData().intValue() >> 4 != this.b || ((NumberTag<?>)((ListTag<?>)object).get(2)).getData().intValue() >> 4 != this.a) {
                        bl = true;
                        continue;
                    }
                    Entity entity = Entity.createEntity(compoundTag.getString("id"), this, compoundTag, new Object[0]);
