...
implements Chunk {
    ...
    public BaseChunk clone() {
        ...
        if (this.biomes != null) {
            baseChunk.biomes = this.biomes.clone();
        }
        baseChunk.heightMap = this.getHeightMapArray().clone();
    ...
    public Block getAndSetBlock(int n, int n2, int n3, Block block) {
        ...
        try {
            this.setChanged();
            return this.sections[n4].getAndSetBlock(n, n2 & 0xF, n3, block);
        }
    ...
    public boolean setFullBlockId(int n, int n2, int n3, int n4) {
        ...
        try {
            this.setChanged();
            return this.sections[n5].setFullBlockId(n, n2 & 0xF, n3, n4);
        }
        catch (ChunkException chunkException) {
            try {
    ...
    public boolean setBlock(int n, int n2, int n3, int n4, int n5) {
        ...
        try {
            this.setChanged();
            return this.sections[n6].setBlock(n, n2 & 0xF, n3, n4, n5);
        }
        catch (ChunkException chunkException) {
            try {
