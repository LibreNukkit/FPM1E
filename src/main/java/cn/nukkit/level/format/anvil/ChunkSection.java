...
implements cn.nukkit.level.format.ChunkSection {
    ...
    public boolean compress() {
        if (this.blockLight != null) {
            ...
            if (this.hasBlockLight && this.hasSkyLight && byArray != EmptyChunkSection.EMPTY_SKY_LIGHT_ARR) {
                byArray3 = Binary.appendBytes(byArray2, new byte[][]{byArray});
    ...
    public ChunkSection copy() {
        return new ChunkSection(this.b, this.a.copy(), this.blockLight == null ? null : this.blockLight.clone(), this.skyLight == null ? null : this.skyLight.clone(), this.compressedLight == null ? null : this.compressedLight.clone(), this.hasBlockLight, this.hasSkyLight);
    }
