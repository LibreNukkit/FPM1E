...
extends BaseChunk {
    ...
    public byte[] toFastBinary() {
        ...
        ArrayList<CompoundTag> arrayList2 = new ArrayList<>();
        for (BlockEntity blockEntity : this.getBlockEntities().values()) {
            blockEntity.saveNBT();
            arrayList2.add(blockEntity.namedTag);
        }
        ListTag<CompoundTag> listTag2 = new ListTag<>("TileEntities");
    ...
    public byte[] toBinary() {
        ...
        compoundTag.putInt("xPos", this.getX());
        compoundTag.putInt("zPos", this.getZ());
        ListTag<CompoundTag> listTag = new ListTag<>("Sections");
        ...
        ListTag<CompoundTag> listTag2 = new ListTag<>("Entities");
        listTag2.setAll(arrayList2);
        compoundTag.putList(listTag2);
        ArrayList<CompoundTag> arrayList3 = new ArrayList<>();
        for (BlockEntity blockEntity : this.getBlockEntities().values()) {
            blockEntity.saveNBT();
