...
extends EntityProjectile {
        ...
        if (this.isCollided && this.shootingEntity instanceof Player) {
            ...
            if (!bl) {
                ...
                if (Server.getInstance().mobsFromBlocks && Utils.rand(1, 20) == 5) {
                    ...
                    Entity entity = Entity.createEntity("Endermite", this.add(0.5, 1.0, 0.5), new Object[0]);
                    if (entity != null) {
                        entity.spawnToAll();
                    }
                }
    ...
    private void a() {
        ...
        if (n == 0 || n == 2) {
            this.shootingEntity.attack(new EntityDamageByEntityEvent(this, this.shootingEntity, EntityDamageEvent.DamageCause.FALL, 5.0f, 0.0f));
        }
