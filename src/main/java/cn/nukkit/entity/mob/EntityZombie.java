    ...
    public void attackEntity(Entity entity) {
        if (this.attackDelay > 23 && entity.distanceSquared(this) <= 1.0) {
            ...
            if (entity instanceof Player) {
                float f2 = 0.0f;
                var object = ((Player)entity).getInventory().getArmorContents();
            ...
            if (entity instanceof EntityVillagerV1 && this.getServer().getDifficulty() > 1 && Utils.rand()) {
                ...
                var object = Entity.createEntity("ZombieVillager", this);
                if (!creatureSpawnEvent.isCancelled() && (object) != null) {
        ...
        if (!this.closed) {
            ...
            if (this.A && this.w == null && this.age % 60 == 0) {
                ...
                for (Entity entity : object) {
                    ...
                    this.B = true;
                    this.getViewers().forEach((n, player) -> this.b(player));
                    break;
                }
            }
