...
implements EntityExplosive {
    ...
    public void onStruckByLightning(Entity entity) {
        if (this.attack(new EntityDamageByEntityEvent(entity, this, EntityDamageEvent.DamageCause.LIGHTNING, 5.0f))) {
            if (this.fireTicks < 160) {
                this.setOnFire(8);
            }
            if (entity instanceof EntityLightningStrike) {
                CreeperPowerEvent creeperPowerEvent = new CreeperPowerEvent(this, (EntityLightningStrike) entity, CreeperPowerEvent.PowerCause.LIGHTNING);
