...
public class Skin {
    ...
    private final List<SkinAnimation> k = new ArrayList<>();
    private final List<PersonaPiece> r = new ArrayList<>();
    private final List<PersonaPieceTint> g = new ArrayList<>();
    ...
    public void generateSkinId(String string) {
        byte[] byArray = Binary.appendBytes(this.getSkinData().data, new byte[][]{this.getSkinResourcePatch().getBytes(StandardCharsets.UTF_8)});
