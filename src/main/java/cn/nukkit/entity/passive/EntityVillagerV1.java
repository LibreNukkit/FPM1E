...
implements InventoryHolder {
    ...
    private final List<TradeInventoryRecipe> A = new ArrayList<>();
    private int u = 0;
    ...
    public void onStruckByLightning(Entity entity) {
        Entity entity2 = Entity.createEntity("Witch", this, new Object[0]);
        if (entity2 != null) {
    ...
    private ListTag<CompoundTag> b() {
        ListTag<CompoundTag> listTag = new ListTag<>("Recipes");
    ...
    private ListTag<CompoundTag> c() {
        ListTag<CompoundTag> listTag = new ListTag<>("TierExpRequirements");
