...
extends EntityVehicle {
            ...
            if (this.age % 5 == 0) {
                ...
                if (n3 > 0) {
                    ...
                    for (Position position : positionArray) {
                        ...
                        this.level.setBlockAt((int) position.x, (int) position.y, (int) position.z, 0, 0);
    ...
    public void updatePassengers(boolean bl) {
        ...
        if (this.passengers.size() == 1) {
            var object = this.passengers.get(0);
            ...
            var object = this.passengers.get(0);
            var object2 = this.passengers.get(1);
