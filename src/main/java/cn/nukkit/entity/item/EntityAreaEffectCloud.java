...
extends Entity {
    ...
    public void saveNBT() {
        super.saveNBT();
        ListTag<CompoundTag> listTag = new ListTag<>("mobEffects");
                    ...
                    for (Entity entity : entityArray) {
                        ...
                        for (Effect effect : this.cloudEffects) {
                            if (effect instanceof InstantEffect) {
                                ...
                                if (bl2) {
                                    entity.attack(new EntityDamageByEntityEvent(this, entity, EntityDamageEvent.DamageCause.MAGIC, (float)(0.5 * (double)(6 << effect.getAmplifier() + 1))));
                                    continue;
                                }
