...
public class EntityManager {
    ...
    private final Map<String, EntityDefinition> b = new HashMap<>();
    private final Map<String, EntityDefinition> g = new HashMap<>();
    private final Int2ObjectMap<EntityDefinition> f = new Int2ObjectOpenHashMap<>();
    ...
    public EntityManager() {
        AddEntityPacket.LEGACY_IDS.forEach((n, string) -> this.c.put(string, n));
    }
