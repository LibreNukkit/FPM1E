...
extends VanillaCommand {
    ...
    public boolean execute(CommandSender commandSender, String string, String[] stringArray) {
        ...
        if (!optional.isPresent()) {
            commandSender.sendMessage(new TranslationContainer("commands.generic.syntax", "/gamerule ", stringArray[0], ' ' + String.join(" ", Arrays.copyOfRange(stringArray, 1, stringArray.length))));
            return true;
        }
        try {
            ...
            commandSender.sendMessage(new TranslationContainer("commands.generic.syntax", "/gamerule " + stringArray[0] + ' ', stringArray[1], ' ' + String.join(" ", Arrays.copyOfRange(stringArray, 2, stringArray.length))));
        }
        return true;
    }
