...
extends VanillaCommand {
    ...
    public boolean execute(CommandSender commandSender, String string, String[] stringArray) {
        ...
        if (stringArray.length == 1) {
            ...
            if (player2 != null) {
                if (player2.isCreative() || player2.isSpectator()) {
                    commandSender.sendMessage(TextFormat.RED + "No targets matched selector");
                    return true;
                }
                EntityDamageEvent entityDamageEvent2 = new EntityDamageEvent(player2, EntityDamageEvent.DamageCause.SUICIDE, 1000.0f);
                ...
                commandSender.sendMessage(new TranslationContainer("commands.kill.successful", string2.isEmpty() ? "0" : string2));
                ...
                EntityDamageEvent entityDamageEvent4 = new EntityDamageEvent(player3, EntityDamageEvent.DamageCause.SUICIDE, 1000.0f);
                ...
                commandSender.sendMessage(new TranslationContainer(TextFormat.GOLD + "%commands.kill.all.successful"));
            } else {
        ...
        if (commandSender instanceof Player) {
            ...
            entityDamageEvent = new EntityDamageEvent(player, EntityDamageEvent.DamageCause.SUICIDE, 1000.0f);
