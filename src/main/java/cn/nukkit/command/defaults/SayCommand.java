...
extends VanillaCommand {
    ...
    public boolean execute(CommandSender commandSender, String string, String[] stringArray) {
        ...
        commandSender.getServer().broadcastMessage(new TranslationContainer(TextFormat.LIGHT_PURPLE + "%chat.type.announcement", string2, TextFormat.LIGHT_PURPLE + stringBuilder.toString()));
        return true;
    }
}
