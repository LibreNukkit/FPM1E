...
public class PluginDescription {
    ...
    private List<Permission> a = new ArrayList<>();
    ...
    private void a(Map<String, Object> map) throws PluginException {
        block16: {
            ...
            this.c = ((String)map.get("version")).toString();
            this.g = (String)map.get("main");
            Object api = map.get("api");
            if (api instanceof List) {
                this.e = (List)api;
            } else {
                var object = new ArrayList<String>();
                object.add((String)api);
                this.e = object;
            }
