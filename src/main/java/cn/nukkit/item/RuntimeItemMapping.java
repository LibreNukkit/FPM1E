...
public class RuntimeItemMapping {
    ...
    public RuntimeItemMapping(Map<String, RuntimeItems.MappingEntry> map, int n) {
        ...
        if (inputStream == null) {
            throw new AssertionError("Unable to load runtime_item_states_" + n + ".json");
        }
    ...
    public LegacyEntry fromRuntime(int n) {
        LegacyEntry legacyEntry = this.runtime2Legacy.get(n);
        if (legacyEntry == null) {
    ...
    public RuntimeEntry toRuntime(int n, int n2) {
        RuntimeEntry runtimeEntry = this.legacy2Runtime.get(this.getFullId(n, n2));
        if (runtimeEntry == null) {
            runtimeEntry = this.legacy2Runtime.get(this.getFullId(n, 0));
        }
        if (runtimeEntry == null) {
            b.warn("(" + this.a + ") Unknown legacy2Runtime mapping: id=" + n + " meta=" + n2);
            runtimeEntry = this.legacy2Runtime.get(this.getFullId(248, 0));
            if (runtimeEntry == null) {
