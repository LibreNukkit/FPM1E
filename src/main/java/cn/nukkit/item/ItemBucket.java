    ...
    public boolean onActivate(Level level, Player player, Block block, Block block2, BlockFace blockFace, double d2, double d3, double d4) {
        ...
        if (block3 instanceof BlockAir) {
            ...
            if (!playerBucketEmptyEvent.isCancelled()) {
                ...
                if (Server.getInstance().mobsFromBlocks && playerBucketEmptyEvent.isMobSpawningAllowed()) {
                    switch (this.getDamage()) {
                        case 2: {
                            cloneable = Entity.createEntity("Cod", block, new Object[0]);
                            if (cloneable == null) break;
                            ((Entity)cloneable).spawnToAll();
                            break;
                        }
                        case 3: {
                            Entity entity = Entity.createEntity("Salmon", block, new Object[0]);
                            if (entity == null) break;
                            entity.spawnToAll();
                            break;
                        }
                        case 4: {
                            Entity entity = Entity.createEntity("TropicalFish", block, new Object[0]);
                            if (entity == null) break;
                            entity.spawnToAll();
                            break;
                        }
                        case 5: {
                            Entity entity = Entity.createEntity("Pufferfish", block, new Object[0]);
                            if (entity == null) break;
                            entity.spawnToAll();
                            break;
                        }
                        case 12: {
                            Entity entity = Entity.createEntity("Axolotl", block, new Object[0]);
                            if (entity == null) break;
                            entity.spawnToAll();
                            break;
                        }
                        case 13: {
                            Entity entity = Entity.createEntity("Tadpole", block, new Object[0]);
                            if (entity == null) break;
                            entity.spawnToAll();
                        }
                    }
            ...
            if (bl) {
                ...
                player.getLevel().addSound(block2, Sound.RANDOM_FIZZ);
