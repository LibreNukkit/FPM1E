...
public class BanList {
    ...
    public void removeExpired() {
        for (String string : new ArrayList<>(this.a.keySet())) {
    ...
    public void load() {
        ...
        try {
            if (!file.exists()) {
                ...
                LinkedList<Map<String,String>> linkedList = new Gson().fromJson(Utils.readFile(this.b), new LinkedListTypeToken(null).getType());
                for (var treeMap : linkedList) {
    ...
    public void save() {
        ...
        try {
            ...
            Utils.writeFile(this.b, new ByteArrayInputStream(new GsonBuilder().setPrettyPrinting().create().toJson(linkedList).getBytes(StandardCharsets.UTF_8)));
        }
        catch (IOException iOException) {
