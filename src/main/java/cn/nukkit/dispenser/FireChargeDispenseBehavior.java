...
extends DefaultDispenseBehavior {
    ...
    public Item dispense(BlockDispenser blockDispenser, BlockFace blockFace, Item item) {
        ...
        Entity entity = Entity.createEntity("GhastFireBall", blockDispenser.level.getChunk(vector3.getChunkX(), vector3.getChunkZ()), Entity.getDefaultNBT(vector3), new Object[0]);
