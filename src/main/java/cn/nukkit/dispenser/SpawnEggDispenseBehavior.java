...
extends DefaultDispenseBehavior {
    ...
    public Item dispense(BlockDispenser blockDispenser, BlockFace blockFace, Item item) {
        ...
        Entity entity = Entity.createEntity(item.getDamage(), blockDispenser.level.getChunk(position.getChunkX(), position.getChunkZ()), Entity.getDefaultNBT(position), new Object[0]);
