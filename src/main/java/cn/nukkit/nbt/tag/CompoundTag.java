...
implements Cloneable {
    ...
    public int getByte(String string) {
        ...
        return ((NumberTag<?>)this.tags.get(string)).getData().intValue();
    }
    ...
    public long getLong(String string) {
        ...
        return ((NumberTag<?>)this.tags.get(string)).getData().longValue();
    }
    ...
    public float getFloat(String string) {
        ...
        return ((NumberTag<?>)this.tags.get(string)).getData().floatValue();
    }
    ...
    public double getDouble(String string) {
        ...
        return ((NumberTag<?>)this.tags.get(string)).getData().doubleValue();
    }
    ...
    public byte[] getByteArray(String string) {
        ...
        return ((ByteArrayTag)this.tags.get(string)).data;
    }
    ...
    public int[] getIntArray(String string) {
        ...
        return ((IntArrayTag)this.tags.get(string)).data;
    }
    ...
    public Map<String, Object> parseValue() {
        HashMap<String, Object> hashMap = new HashMap<>(this.tags.size());
        for (Map.Entry<String, Tag> entry : this.tags.entrySet()) {
    ...
    public boolean getBoolean(String string, boolean bl) {
        ...
        return ((NumberTag<?>)this.tags.get(string)).getData().intValue() != 0;
    }
    ...
    public CompoundTag clone() {
        ...
        this.getTags().forEach((string, tag) -> compoundTag.put(string, tag.copy()));
        return compoundTag;
    }
